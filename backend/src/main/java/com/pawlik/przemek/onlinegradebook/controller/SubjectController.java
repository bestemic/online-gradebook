...
public class SubjectController {
    ...
    public ResponseEntity<List<SubjectDto>> getAllSubjects(
            @Parameter(name = "classId", description = "Class id", example = "3") @RequestParam(required = false) Long classId,
            @Parameter(name = "teacherId", description = "Teacher id", example = "5") @RequestParam(required = false) Long teacherId) {
